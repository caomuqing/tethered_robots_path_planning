...
class auto_commands:
    ...
    def publishgoals(self):
        ...
        msg_neptune2 = Float32MultiArray(); 
        for i in range(0, number_of_robots):
            msg=PoseStamped()  
            ...
            msg_neptune2.data.append(self.goals[i][0]); #goal positions
            msg_neptune2.data.append(self.goals[i][1]);
            msg_neptune2.data.append(goal_height);
